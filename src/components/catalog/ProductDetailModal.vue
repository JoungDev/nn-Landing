        ...
        <div v-if="isOpen && product" class="product-modal" role="dialog" aria-modal="true"
            ...
            <div class="product-modal__panel">
                ...
                <div class="product-modal__gallery">
                    ...
                    <div v-if="product.images.length > 1" class="product-modal__thumbnails">
                        <button v-for="(image, index) in product.images" :key="image.src"
                            class="product-modal__thumbnail" :class="{
                ...
                <div class="product-modal__content">
                    ...
                    <h2 :id="`product-modal-title-${product.id}`" class="product-modal__title">
                        {{ product.name }}
                    </h2>
                    ...
                    <div v-if="product.status === 'sold-out'" class="product-modal__sold-out">
                        <span>Sold out</span>

                        <p>
                            Esta pieza se encuentra agotada. Puedes conocer su historia y conservarla
                            como parte de la memoria de nuestras colecciones.
                        </p>
                    </div>
